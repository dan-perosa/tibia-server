local internalNpcName = "Blessing Merchant"
...
npcHandler:setMessage(MESSAGE_GREET, "Hey |PLAYERNAME|. I'm the Blessing Merchant and I can give {money}, {experience} and {blessing} which will be useful for testing on " .. configManager.getString(configKeys.SERVER_NAME) .. " server." .. " You can too to back to level 8 with {reset}.")
