...
-- Values must match the server's CipbiaSkills_t enum (canary/src/utils/utils_definitions.hpp),
-- not an arbitrary 1..8 sequence -- this table previously used guessed values that didn't match
-- the real protocol IDs, so every skill-up banner except Magic Level showed the wrong name.
local SkillId = {
    Magic = 1,
    Shielding = 6,
    Distance = 7,
